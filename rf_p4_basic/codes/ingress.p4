...
control MyIngress(inout headers hdr,
    ...
    action SetCode_f0(bit<128> code0, bit<128> code1, bit<128> code2) {
        meta.cw_t0[255:128] = code0;
        meta.cw_t1[255:128] = code1;
        meta.cw_t2[255:128] = code2;
    }
    action SetCode_f1(bit<128> code0, bit<128> code1, bit<128> code2) {
        meta.cw_t0[127:0] = code0;
        meta.cw_t1[127:0] = code1;
        meta.cw_t2[127:0] = code2;
    }
